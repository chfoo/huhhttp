...
POSTS = {
    ...
    long I hope you don’t fall asleep! A few days ago I went in a walking
    ...
    a huge success! Sorry for a lame joke —hmm oh, ok.
    In all seriousness, Smaug and I
    have created a time traveling machine. We’re a bit too early and we lost
    ...
    <p>So, we’re living in the 90s. And we can shapeshift provided
    that we don’t exceed 500 Kgs. <i>
    ...
    <P>Hello!
    <P>
    <P>Please continue enjoy you’re stay!~
    ''',
    (1997, 3, 27): '''
    <P>
    ...
    cash on our hands, he—well, rather—we ran up to a random unattended car
    and quickly sat at the driver’s seat. We slam on the pedal and the car
    takes off. We nearly miss a tree and we were racing down the highway.
    Then, he says, “This is boring” <i>It was exceedingly boring.</i>
    ...
    the sky. <i>Flying is much better.</i> Seriously, I don’t think we’ll
    ...
    means <strong>forever</strong>.</i></p>You’ve could have died!
    I could have died!
    ''',
    (1997, 4, 23): '''
    ...
    ''',
    (1998, 6, 3): '''
    <P>I’m very sorry for not update this Web Site. Please Continue
    to enjoy your stay!
    <P>Smile for Smaug! ~~
    ''',
    (2007, 10, 3): '''
    ...
    <p>Don’t forget to praise Smaug everyday :)
    ''',
    (2010, 8, 25): '''
    ...
    someone is Smaug.
    <p>Smaug, I’m sorry that we didn’t meet your funding goal for chocolate
    coins but I think you’re starting to get fat. Now we all know! And if
    you try to kill me, I’ll tell everyone your secret.
    ...
    ''',
    (2010, 9, 2): '''
    <p>If you truely believe in Smaug, then you’ll believe in Bitcoins.
    <i>I love Bitcoins.</i>
    <h3>What are Bitcoins?</h3>
    <p>Bitcoin is digital currency. It’s money but done through the internet.
    <i>Use Bitcoin.</i>
    ...
    on the internet. But don’t worry, Bitcoin does not identify anyone.
    Instead, special addresses are generated by the Bitcoin software. If you’d
    ...
    “double-spending”. Once your transaction has been confirmed by
    ...
    Smaug about it and he said the website’s code is a mess and it is not
    worth it to see why I can’t delete anything.
    <p>I’ve been really busy with university so there isn’t going to be
    ...
    <p>We’re done here. Good bye.
    ''',
    (2014, 3, 10): '''
    <p>Uh what was that about? I have no idea what’s up with this site and
    the phantom posts.
    <p>Again, there isn’t much to update. The same thing is up with Smaug:
    ...
    people that Smaug won’t kill again, etc.
    <p>If you’re interested in more personal things, follow Smaug’s Twitter
